...
import 'package:gyzyleller/modules/settings_profile/views/webview.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:flutter/material.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class WalletController extends GetxController {
  final RefreshController walletRefreshController =
      RefreshController(initialRefresh: false);
  final RefreshController addCashRefreshController =
      RefreshController(initialRefresh: false);
  ...
  Future<void> _createOrder(int bankId, BuildContext dialogContext) async {
    try {
      ...
      if (response is Map<String, dynamic> && response['formUrl'] != null) {
        final url = response['formUrl'] as String; // keep it as a String
        _launchURL(url);
      }
    } catch (e) {
