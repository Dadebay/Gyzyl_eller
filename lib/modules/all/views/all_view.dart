  ...
  void _openFilterBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (_) => FilterBottomSheet(
        ...
        onApply: (filters) {
          print('🗓️ [AllView] Filter tarih seçildi: ${filters['dates']}');
          print(
              '🌐 [AllView] Bu filtre `AllController.applyFilters` aracılığıyla `MyJobsService.getMyJobs` API çağrısına gönderilecek.');
