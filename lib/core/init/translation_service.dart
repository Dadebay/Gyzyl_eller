...
class TranslationService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'tk': {
          ...
          'select_payment_method': 'Toleg usulyny saýlaň',
          ...
          'summ_to_send': 'Ugradyljak summa',
          'how_much': 'Nace?',
          'remind_money': 'Pul barada ýatlatma',
          'your_balance': 'Siziň hasabyňyz',
          'continue': 'Dowam et',
          'toleg': 'Toleg',
          'bank': 'Bank',
          'money_added': 'Hasap dolduryldy',
          'tarif_bought': 'Tarif satyn alyndy',
          'stories_bought': 'Stori satyn alyndy',
          'sale_bought': 'Satyş satyn alyndy',
          'refund': 'Yzyna gaýtaryldy',
          'ad_bought': 'Bildiriş satyn alyndy',
          'promo_bought': 'Promo satyn alyndy',
          'unknown_transaction': 'Näbelli amal',
          'alyndy': 'alyndy',
          'gecdi': 'geçdi',
          'error': 'Ýalňyşlyk',
          'refresh': 'Tazele',
        ...
        'ru': {
          ...
          'summ_to_send': 'Сумма к отправке',
          'how_much': 'Сколько?',
          'remind_money': 'Напоминание',
          'your_balance': 'Ваш баланс',
          'continue': 'Продолжить',
          'toleg': 'Оплата',
          'bank': 'Банк',
          'money_added': 'Пополнение счета',
          'tarif_bought': 'Покупка тарифа',
          'stories_bought': 'Покупка сториз',
          'sale_bought': 'Покупка продажи',
          'refund': 'Возврат',
          'ad_bought': 'Покупка объявления',
          'promo_bought': 'Покупка промо',
          'unknown_transaction': 'Неизвестная транзакция',
          'alyndy': 'списано',
          'gecdi': 'прошло',
          'error': 'Ошибка',
          'refresh': 'Обновить',
